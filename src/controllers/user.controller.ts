...
const generateAccessAndRefereshTokens = async (userId: unknown) => {
  try {
...
const logoutUser = asyncHandler(async (req: Request & { user?: any }, res) => {
...
const updateUserAvatar = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
const updateUserCoverImage = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
